...
- The pipeline now enforces configurable thresholds from `configs/pipeline.yml`.
- It fails fast if null-rate/range-violation/consistency-violation limits are exceeded.
- Tune thresholds under `quality_gate` for strict vs exploratory runs.
